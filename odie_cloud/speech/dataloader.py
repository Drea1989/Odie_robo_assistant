...
def common_config(manifest_file, batch_size,  nbands,  max_utt_len):
...
def make_loader(manifest_file, nbands,  max_utt_len, backend_obj):
    logger.debug("[Deepspeech] audio transform")
    aeon_config = common_config(manifest_file, backend_obj.bsz, nbands, max_utt_len)
