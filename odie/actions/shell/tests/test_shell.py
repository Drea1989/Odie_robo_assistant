...
from odie.actions.shell.shell import Shell
...
class TestShell(unittest.TestCase):
    ...
    def test_shell_returned_code(self):
        """
        To test that the shell action works, we ask it to create a file
        """
        parameters = {
    ...
    def test_async_shell(self):
        """
        Test that the action can run a shell command asynchronously
        """
        parameters = {
            "cmd": "touch %s" % self.test_file,
            "async": True
