...
class TestScript(unittest.TestCase):
    ...
    def setUp(self):
        self.path = "path"
        self.random = "random"
        self.test_file = "/tmp/odie_text_shell.txt"
    ...
    def testParameters(self):
        ...
        # random path
        self.path = "/tmp/iamarandompath/anotherrandompath/odie"
        parameters = {
            "path": self.path
        }
        ...
        tmp_path = "/tmp/odie/tests/"
        tmp_file_path = tmp_path+"actionScript"
        if not os.path.exists(tmp_path):
            os.makedirs(tmp_path)
        text_to_write = "[odie-test] TestScript - testParameters"
    ...
    def test_script_execution(self):
        ...
        """
        param = {
            "path": "odie/actions/script/tests/test_script.sh"
        }
    ...
    def test_script_content(self):
        ...
        # get the output with the action
        parameters = {
            "path": "odie/actions/script/tests/test_script_cat.sh",
        }
