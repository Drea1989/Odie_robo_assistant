...
from odie.core.ActionModule import InvalidParameterException
from odie.actions.uri.uri import Uri


class TestUri(unittest.TestCase):

    def setUp(self):
        self.test_url = "http://odie.en/voices/"
    ...
    def testGet(self):
        ...
        uri_action = Uri(**parameters)
        self.assertEqual(uri_action.text, expected_content)
    ...
    def testGetRaw(self):
        ...
        uri_action = Uri(**parameters)
        self.assertEqual(uri_action.content, expected_content)
    ...
    def testHead(self):
        ...
        uri_action = Uri(**parameters)
        self.assertEqual(uri_action.status_code, 200)
    ...
    def testPostJsonFromFile(self):
        ...
        parameters = {
            "url": self.test_url,
            "method": "POST",
            "data_from_file": "odie/actions/uri/tests/data_post_test.json",
            "headers": {
