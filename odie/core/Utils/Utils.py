...
class Utils(object):
    ...
    def get_real_file_path(cls, file_path_to_test):
        ...
        - from the current directory where odie has been called + the file_path_to_test.
        Eg: /home/me/Documents/odie_config
        - from /etc/odie + file_path_to_test
        ...
        if not os.path.isabs(file_path_to_test):
            ...
            path_order = {
                ...
                2: "/etc/odie" + os.sep + file_path_to_test,
                # In this case 'get_current_file_parent_parent_path' is corresponding to odie root path
                # from /an/unknown/path/odie/odie/core/Utils to /an/unknown/path/odie/odie
