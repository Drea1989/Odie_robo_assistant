...
class Topic(object):
    def __init__(self, name=None, neurons=None, is_json=False):
        self.name = name
...
class Broker(object):
    def __init__(self, broker_ip=None, topics=None, port=1883, client_id="odie", keepalive=60,
    ...
    def build_from_cue_dict(self, dict_parameters):
        """
