...
class TestUtils(unittest.TestCase):
    ...
    def test_get_current_file_parent_path(self):
        ...
        """
        path_to_test = "../odie/core/Utils"
        expected_result = os.path.normpath("../odie/core")
    ...
    def test_get_current_file_parent_parent_path(self):
        ...
        """
        path_to_test = "../odie/core/Utils"
        expected_result = os.path.normpath("../odie")
    ...
    def test_get_real_file_path(self):
        ...
        Expect to load the proper file following the order :
            ...
            - /etc/odie + file_name
            - /path/to/odie/ +file_name
        """
        ###
        # Test the absolute path
        dir_path = "/tmp/odie/tests/"
        ...
        # expected_result = "/etc/odie" + os.sep + file_name
        # if not os.path.exists(dir_path):
        #     os.makedirs(dir_path)
        #
        # # touch the file
        ...
        #                   expected_result,
        #                   "Fail to match the /etc/odie path")
        # # Clean up
        # if os.path.exists(file_name):
        #     os.remove(file_name)
        ...
        self.assertEqual(Utils.get_real_file_path(file_name),
                         expected_result,
                         "Fail to match the /an/unknown/path/odie path")
        # Clean up
    ...
    def test_get_dynamic_class_instantiation(self):
        ...
        action = Action(name='Say', parameters={'message': 'test dynamic class instantiate'})
        self.assertTrue(isinstance(Utils.get_dynamic_class_instantiation(package_name="actions",
                                                                         module_name=action.name.capitalize(),
    ...
    def test_is_containing_bracket(self):
        ...
        # Behaviour unicode
        order_to_test = "we like the mustard"
        self.assertFalse(Utils.is_containing_bracket(order_to_test),
                         "Fail returning False when an int")
