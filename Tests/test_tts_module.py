...
from odie.core.TTS.TTSModule import TTSModule, TtsGenerateAudioFunctionNotFound
...
class TestTTSModule(unittest.TestCase):
    ...
    def test_generate_md5_from_words(self):
        ...
        word = "odie"
        expected_result = "69c692c4997cdddef3dd473a96fa811e"
    ...
    def test_get_path_to_store_audio(self):
        ...
        self.TTSMod.words = "odie"
        settings = Settings(cache_path="/tmp/odie/tests")
        self.TTSMod.settings = settings

        expected_result = "/tmp/odie/tests/TTSModule/tests/default/69c692c4997cdddef3dd473a96fa811e.tts"
    ...
    def test_generate_and_play(self):
        ...
        with mock.patch.object(TTSModule, 'play_audio', new=new_play_audio):
            ...
            # create tmp file
            tmp_base_path = "/tmp/odie/tests/TTSModule/tests/default/"
            file_path = os.path.join(tmp_base_path, "69c692c4997cdddef3dd473a96fa811e.tts")
            if os.path.isfile(file_path):
                # Remove the file
                FileManager.remove_file(file_path)
            if not os.path.exists(tmp_base_path):
                os.makedirs(tmp_base_path)
            FileManager.write_in_file(file_path, "[odie-test] test_generate_and_play")
            self.TTSMod.cache = True
            generate_audio_function_from_child = mock.Mock()
            self.TTSMod.generate_and_play(words=words,
                                          generate_audio_function_from_child=generate_audio_function_from_child)
    ...
    def test_is_file_already_in_cache(self):
        ...
        base_cache_path = "/tmp/odie/tests/TTSModule/tests/default/"
        md5_word = "69c692c4997cdddef3dd473a96fa811e"
        file_path = os.path.join(base_cache_path, "69c692c4997cdddef3dd473a96fa811e.tts")
        ...
        FileManager.write_in_file(tmp_path, "[odie-test] test_is_file_already_in_cache")
