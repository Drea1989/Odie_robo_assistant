...
class TestFileManager(unittest.TestCase):
    ...
    def test_create_directory(self):
        ...
        """
        # set up
        cache_path = "/tmp/odie/tests/testDirectory"
    ...
    def test_write_in_file(self):
        ...
        in_file_text = "[Odie] Testing the write_in_file method from Utils.FileManager"
    ...
    def test_is_path_exists_or_creatable(self):
        ...
        with open(file_path, "wb") as file_open:
            file_open.write(b"[Odie] Test Running the test_is_path_exists_or_creatable method")
            file_open.close()
