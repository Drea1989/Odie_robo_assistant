...
for an Enterprise version of the software contact the Author at <andrea.balzano@live.it>. for full details see the [license](https://github.com/Drea1989/Odie_robo_assistant/blob/master/LICENSE)
