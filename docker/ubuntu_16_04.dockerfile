# used to build the last odie dev version with python 3
# docker build --force-rm=true -t odie-ubuntu1604-python3 -f docker/ubuntu_16_04.dockerfile .
# docker run -it --rm odie-ubuntu1604-python3

FROM ubuntu:16.04

ENV no_proxy="127.0.0.1,localhost,odie.com.au"
...
ADD docker/clone_and_test_python3.sh /home/tester/clone_and_test_python.sh
RUN chown tester /home/tester/clone_and_test_python.sh

USER tester
WORKDIR /home/tester

# run tests
CMD ./clone_and_test_python.sh